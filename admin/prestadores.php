...
<head>
    ...
    <title>Prestadores na plataforma</title>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.html" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">Mudanças</span>
            </a>
    ...
    <main id="main" class="main">
        <div class="col-12">
            <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                    <h5 class="card-title">Lista de prestadores</h5>
                    <table class="table datatable">
                        ...
                        <tbody>
                            ...
                            foreach ($prestadores as $prestador) { ?>
                                <tr>
                                    <th scope="row"><a href="#">#<?= $prestador->idprestador ?></a></th>
                                    <td><?= $prestador->prestador_nome ?></td>
                                    <td>Mudanças</td>
                                    <td><?= $prestador->prestador_whatsapp ?></td>
                                    <td><span class="badge bg-warning">Approved</span></td>
                                    <td><a href="./info-prestador.php?id-prestador=<?= $prestador->idprestador ?>" class="nav-link text-primary">ver detalhes</a></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
